export const ctmiResults = {
  "EHMS": {
    ...
    description: "따뜻함과 진심을 중요시하는 당신은, 언제나 주변에 안정감을 주는 존재예요. 겉으론 조용해 보여도, 속엔 누구보다 강한 신념이 있어요. 사람들은 당신 옆에 있으면 이상하게 마음이 놓인다고 해요.",
  ...
  "BHMU": {
    ...
    description: "클래식한 감성에 자기만의 고유 템포가 있어요. 튀지는 않지만, 깊이 있는 매력으로 오래 기억되는 스타일. 소리 없이 중심을 잡아주는 든든한 존재죠.",
  ...
  "BIMU": {
    ...
    description: "사회생활도, 사생활도 모두 완벽하게 조율하는 사람. 거리는 유지하면서도, 필요한 온기를 전할 줄 아는 타입. 중심을 잃지 않는 균형감각이 돋보여요.",
  ...
  "BINU": {
    ...
    description: "군더더기 없이, 깔끔하게 살아가는 당신. 남들의 기준보다 자신의 원칙을 더 중요시하죠. 진실된 삶을 지향하는 묵직한 신뢰감의 소유자예요.",
